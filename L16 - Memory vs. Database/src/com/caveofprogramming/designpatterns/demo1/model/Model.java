...
public class Model {
	...
	public void save() throws Exception {
		...
		/*
		 * Note: this very simple implementation takes no account of what would happen
		 * if multiple users were using this application. In this case, we'd probably
		 * want to think of stuff like stored procedures, transactions and so on, and
		 * how to handle the case where multiple users try to modify the same person
